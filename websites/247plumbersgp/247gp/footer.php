...
<footer>
  <div class="container">
    <div class="footer-grid">
      <div>
        <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/images/logo.png'); ?>" alt="247 Plumbers GP" style="width:64px;height:64px;border-radius:8px;margin-bottom:14px">
        <div class="footer-brand">247 Plumbers GP</div>
        <p class="footer-desc">PIRB-registered plumbers based in Midrand, serving all of Gauteng. Available 24/7 — no call-out fee, workmanship guaranteed.</p>
    ...
    <div class="footer-bottom">
      <p>&copy; <?php echo date('Y'); ?> 247 Plumbers GP · Midrand, Gauteng</p>
