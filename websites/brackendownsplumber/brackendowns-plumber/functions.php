...
add_filter('wpseo_opengraph_image', function($image) {
    ...
    return get_template_directory_uri() . '/assets/images/geyser-branded.jpg'; // kept as JPG — WebP has inconsistent Open Graph/social-preview support
});
...
function gp_create_all_pages() {
    ...
    $areas_data = [
        ...
        'kempton-park' => ['Kempton Park', 'Plumber in Kempton Park. Emergency plumbing, geyser repairs, drain cleaning and leak detection. No call-out fee. Call 073 537 6298.', 'Kempton Park\'s growth around OR Tambo International Airport means the area combines established residential suburbs like Glen Marais and Birch Acres with a large concentration of logistics parks, warehousing and freight businesses. Alongside routine household plumbing, we handle commercial plumbing for the warehouses and logistics operators based here, where a burst pipe or blocked drain at a working freight facility needs a faster response than a typical residential call-out.'],
