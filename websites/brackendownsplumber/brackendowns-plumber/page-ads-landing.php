 ...
 * Brackendowns Plumber — minimal page for Google Ads traffic.
...
<div class="al-wrap">
  ...
  <div class="al-logo">
    <img src="<?php echo esc_url($imgdir . 'logo-compact.png'); ?>" alt="Brackendowns Plumber" style="height:48px;width:auto">
    <span>Brackendowns Plumber</span>
  </div>

  <div class="al-hero">
    <h1>Plumber Near You, <span>Anywhere in Gauteng.</span></h1>
