    ...
    <div class="hero-inner">
      <div>
        ...
        <div class="hero-proof">
          ...
          <div class="proof-item"><div class="proof-dot"><svg width="14" height="14" fill="#F87171" viewBox="0 0 24 24"><path d="M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21z"/></svg></div><span class="proof-text">4.8★ Google<br>Rated</span></div>
...
<div class="stats-bar"><div class="stats-grid">
  ...
  <div class="stat-block"><div class="stat-num">4<span>.</span>8<span>★</span></div><div class="stat-label">Google Rating</div></div>
</div></div>
...
<section style="background:#fff;padding:48px 0">
  <div class="container">
    ...
    <div class="photo-strip-grid">
      ...
      <img src="<?php echo esc_url($imgdir . 'job-geyser-roofspace.webp'); ?>" alt="Brackendowns Plumber geyser repair technician">
      <img src="<?php echo esc_url($imgdir . 'job-water-meter-valve.webp'); ?>" alt="Brackendowns Plumber water meter and pressure valve installation">
      <img src="<?php echo esc_url($imgdir . 'job-pipe-excavation.webp'); ?>" alt="Brackendowns Plumber pipe repair technician">
      <img src="<?php echo esc_url($imgdir . 'job-ariston-install.webp'); ?>" alt="Brackendowns Plumber geyser installation">
    </div>
  </div>
</section>
...
<section id="faq" class="section">
  <div class="container" style="max-width:800px">
    ...
    <div class="faq-list">
      ...
      <div class="faq-item"><div class="faq-q" onclick="toggleFaq(this)">How do I find a reliable, licensed plumber in Alberton?<div class="faq-icon"><svg viewBox="0 0 24 24"><path d="M7 10l5 5 5-5z"/></svg></div></div><div class="faq-a">Check for PIRB registration (South Africa's Plumbing Industry Registration Board), a fixed local address rather than just a call centre, and reviews you can actually verify on Google. Brackendowns Plumber is PIRB-registered and based in Brackendowns, with all our reviews visible on our Google Business Profile.</div></div>
      <div class="faq-item"><div class="faq-q" onclick="toggleFaq(this)">Where can I see reviews for Brackendowns Plumber?<div class="faq-icon"><svg viewBox="0 0 24 24"><path d="M7 10l5 5 5-5z"/></svg></div></div><div class="faq-a">All our reviews are on our Google Business Profile — <a href="<?php echo esc_url($google); ?>" target="_blank">view them here</a>. We don't publish selected quotes elsewhere without linking back to the real source.</div></div>
    </div>
  </div>
</section>
    ...
    <div class="contact-2col">
      <div>
        ...
        <div>
          ...
          <div class="cm"><div class="cm-i"><svg width="19" height="19" fill="#F87171" viewBox="0 0 24 24"><path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z"/></svg></div><div><div class="cm-l">Location</div><div class="cm-v" style="color:#CBD5E1">25 Bamboes St, Brackendowns, Alberton, 1454</div></div></div>
      ...
      <div>
        ...
        <?php else: ?>
        <div class="map-wrap">
          <iframe src="https://www.google.com/maps?q=M35V%2BWM+Alberton&output=embed" allowfullscreen loading="lazy" title="Brackendowns Plumber location — Brackendowns"></iframe>
        </div>
        <?php endif; ?>
        <div class="cf-box">
