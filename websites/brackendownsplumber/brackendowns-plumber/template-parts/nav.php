...
<nav id="site-nav">
  <div class="nav-inner">
    ...
    <!-- LOGO -->
    <a href="<?php echo esc_url($home_url); ?>" class="logo" aria-label="Brackendowns Plumber Home">
      <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/images/logo-compact.png'); ?>" alt="Brackendowns Plumber" class="logo-img">
      <div class="logo-sub-wrap">
        <div class="logo-sub">Brackendowns · East Rand · 24/7</div>
      </div>
    </a>
