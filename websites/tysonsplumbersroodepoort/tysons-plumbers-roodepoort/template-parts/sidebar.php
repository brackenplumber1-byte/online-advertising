...
<aside>
  <div class="sidebar-box">
    <div class="sidebar-head"><h3>Get a Free Quote</h3><p>We call back within 15 minutes</p></div>
    <div class="sidebar-body">
      <a href="<?php echo esc_attr(tp_plink()); ?>" class="sidebar-call">
        <svg viewBox="0 0 24 24"><path d="M6.62 10.79c1.44 2.83 3.76 5.14 6.59 6.59l2.2-2.2c.27-.27.67-.36 1.02-.24 1.12.37 2.33.57 3.57.57.55 0 1 .45 1 1V20c0 .55-.45 1-1 1-9.39 0-17-7.61-17-17 0-.55.45-1 1-1h3.5c.55 0 1 .45 1 1 0 1.25.2 2.45.57 3.57.11.35.03.74-.25 1.02l-2.2 2.2z"/></svg>
        <div><div class="sidebar-call-label">Call Now — Free</div><div class="sidebar-call-num"><?php echo esc_html(tp_phone()); ?></div></div>
      </a>
      <a href="<?php echo esc_url(tp_wa_link()); ?>" target="_blank" class="sidebar-wa">
      ...
      <div class="sidebar-form">
        <form method="post" action="<?php echo esc_url(admin_url('admin-post.php')); ?>">
          ...
          <input type="tel" name="tp_phone" placeholder="Your phone number" required>
          <select name="tp_service">
            <option>Emergency Plumbing</option><option>Geyser Repair</option>
            <option>Drain Cleaning</option><option>Pipe Repair</option>
            <option>Leak Detection</option><option>Toilet Repairs</option>
            <option>Water Backup Tank</option><option>Other</option>
          </select>
