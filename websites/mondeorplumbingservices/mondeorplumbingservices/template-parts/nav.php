...
<nav id="site-nav">
  <div class="nav-inner">
    ...
    <!-- LOGO -->
    <a href="<?php echo esc_url($home_url); ?>" class="logo" aria-label="Mondeor Plumbing Services Home">
      <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/images/logo-icon.png'); ?>" alt="Mondeor Plumbing Services" class="logo-img">
      <div class="logo-sub-wrap" style="flex-direction:column;align-items:flex-start;line-height:1.15">
        <div style="font-size:1.05rem;font-weight:800"><span style="color:var(--navy)">Mondeor</span> <span style="color:var(--red)">Plumbing</span> <span style="color:var(--navy)">Services</span></div>
        <div class="logo-sub">Mondeor · Johannesburg South · 24/7</div>
      </div>
    </a>
    ...
    <ul class="nav-links" role="list">
      ...
      <li><a href="<?php echo esc_url(gp_anchor('process')); ?>">Our Process</a></li>
