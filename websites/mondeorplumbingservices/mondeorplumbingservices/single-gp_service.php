...
<?php while (have_posts()): the_post();
    ...
    $svc_photos = [
        'burst-pipe-repairs'       => 'job-underground-pipe.webp',
        'geyser-replacements'      => 'job-geyser-replacement.webp',
        'gutters-downpipes'        => 'job-jojo-tank.webp',
        'plumbing-maintenance'     => 'job-kitchen-tap.webp',
        'grease-trap-cleaning'     => 'job-drain-manhole.webp',
        'leak-detection'           => 'job-leak-detection.webp',
        'drain-specialists'        => 'job-tree-root-drain.webp',
        'drain-camera-inspections' => 'mondeor-plumber-basin-install.webp',
        'heat-pumps'               => 'job-geyser-dark-roofspace.webp',
        'gas-geyser-installations' => 'job-geyser-highpressure.webp',
        'water-filtration'         => 'mondeor-geyser-installation.webp',
        'maintenance-contracts'    => 'job-pressure-valve.webp',
        'industrial-plumbing'      => 'job-geyser-roofspace.webp',
        'geyser-repair'            => 'job-geyser-dark-roofspace.webp',
        'water-backup-tanks'       => 'job-jojo-tank.webp',
        'toilet-repairs'           => 'mondeor-plumber-basin-install.webp',
...
<div class="container">
  <div class="content-grid">
    <div class="content-body">
      ...
      <?php
      $svc_extra_photos = [
        'burst-pipe-repairs'       => ['job-pressure-valve.webp'],
        'geyser-replacements'      => ['job-geyser-roofspace.webp', 'job-geyser-dark-roofspace.webp'],
        'gutters-downpipes'        => [],
        'plumbing-maintenance'     => ['job-pressure-valve.webp'],
        'grease-trap-cleaning'     => ['job-tree-root-drain.webp'],
        'leak-detection'           => ['job-underground-pipe.webp'],
        'drain-specialists'        => ['job-drain-manhole.webp'],
        'drain-camera-inspections' => ['job-drain-manhole.webp'],
        'heat-pumps'               => ['job-geyser-highpressure.webp'],
        'gas-geyser-installations' => ['job-geyser-roofspace.webp'],
        'water-filtration'         => ['job-jojo-tank.webp'],
        'maintenance-contracts'    => ['job-kitchen-tap.webp'],
        'industrial-plumbing'      => ['job-underground-pipe.webp'],
        'geyser-repair'            => ['job-geyser-highpressure.webp'],
        'water-backup-tanks'       => ['job-underground-pipe.webp'],
        'toilet-repairs'           => ['job-kitchen-tap.webp'],
        'bathroom-plumbing'        => ['mondeor-plumber-basin-install.webp'],
      ];
