  ...
  <div class="content-grid">
    <div class="content-body article-body">
      ...
      <div class="highlight-box" style="margin-top:32px">
        <h3>Need a Plumber in Mondeor or Johannesburg South Right Now?</h3>
        <p>Call <strong><a href="<?php echo esc_attr(gp_phone_link()); ?>" style="color:var(--red)"><?php echo esc_html(gp_phone()); ?></a></strong> — available 24/7, no call-out fee, fast response across Johannesburg South.</p>
      </div>
    </div>
