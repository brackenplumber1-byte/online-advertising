...
<footer>
  <div class="container">
    <div class="footer-grid">
      <div>
        <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/images/logo-icon.png'); ?>" alt="Mondeor Plumbing Services" style="width:64px;height:64px;border-radius:8px;margin-bottom:14px">
        <div class="footer-brand">Mondeor Plumbing Services</div>
        <p class="footer-desc">PIRB-registered plumbers based in Mondeor, serving Johannesburg South. Available 24/7 — no call-out fee, workmanship guaranteed.</p>
        ...
        <div style="margin-top:16px;display:flex;gap:10px;flex-wrap:wrap">
          ...
          <?php if (gp_ig()): ?><a href="<?php echo esc_url(gp_ig()); ?>" target="_blank" style="color:#64748B;font-size:.82rem;font-weight:600">Instagram</a><?php endif; ?>
          <?php if (GP_YT): ?><a href="<?php echo esc_url(GP_YT); ?>" target="_blank" style="color:#64748B;font-size:.82rem;font-weight:600">YouTube</a><?php endif; ?>
    ...
    <div class="footer-bottom">
      <p>&copy; <?php echo date('Y'); ?> Mondeor Plumbing Services · Mondeor, Johannesburg South</p>
      <div class="footer-soc">
        ...
        <?php if (gp_ig()): ?><a href="<?php echo esc_url(gp_ig()); ?>" target="_blank"><svg viewBox="0 0 24 24" fill="none" stroke="#475569" stroke-width="2"><rect x="2" y="2" width="20" height="20" rx="5"/><circle cx="12" cy="12" r="4"/><circle cx="17.5" cy="6.5" r="1" fill="#475569" stroke="none"/></svg></a><?php endif; ?>
        <?php if (GP_YT): ?><a href="<?php echo esc_url(GP_YT); ?>" target="_blank"><svg viewBox="0 0 24 24"><path d="M21.582 7.186a2.506 2.506 0 0 0-1.768-1.768C18.254 5 12 5 12 5s-6.254 0-7.814.418a2.506 2.506 0 0 0-1.768 1.768C2 8.746 2 12 2 12s0 3.254.418 4.814a2.506 2.506 0 0 0 1.768 1.768C5.746 19 12 19 12 19s6.254 0 7.814-.418a2.506 2.506 0 0 0 1.768-1.768C22 15.254 22 12 22 12s0-3.254-.418-4.814zM10 15.5v-7l6 3.5-6 3.5z" fill="#475569"/></svg></a><?php endif; ?>
