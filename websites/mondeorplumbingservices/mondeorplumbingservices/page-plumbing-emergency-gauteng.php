<?php
/**
 * Template Name: Article - Plumbing Emergency Guide
 */
get_header();
$phone = gp_phone();
$plink = gp_phone_link();
...
<nav class="breadcrumb" aria-label="Breadcrumb"><div class="container">
  <ol itemscope itemtype="https://schema.org/BreadcrumbList">
    ...
    <li itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem"><span itemprop="name">Plumbing Emergency Guide</span><meta itemprop="position" content="3"/></li>
  </ol>
</div></nav>
<div class="page-hero">
  ...
  <div class="container">
    ...
    <h1 class="display">Plumbing Emergency?<br>Here's What to Do</h1>
  ...
  <div class="content-grid">
    <div class="content-body article-body">
      ...
      <div class="highlight-box">
        <h3>Emergency Plumber — Call Now</h3>
        <p>Save our number before you need it: <strong><a href="<?php echo esc_attr($plink); ?>" style="color:var(--red)"><?php echo esc_html($phone); ?></a></strong>. Available across Mondeor, Kibler Park, Meredale, Ormonde, Ridgeway, Winchester Hills, Bassonia, Meyersdal, Brackendowns, Brackenhurst, Aeroton, Glenvista and Mulbarton. No call-out fee.</p>
      </div>
