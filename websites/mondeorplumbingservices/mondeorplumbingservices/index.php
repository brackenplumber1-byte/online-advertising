...
<section id="home" class="hero">
  ...
  <div class="container">
    <div class="hero-inner">
      <div>
        <div class="hero-eyebrow">Mondeor · Johannesburg South · 24/7</div>
        <h1>Your Local Plumber in <span>Mondeor</span>,<br>Day or Night.</h1>
        <p class="hero-sub">Searching for a plumber near me in Mondeor? You've found Johannesburg South's trusted local plumbers, <strong>on call 24 hours a day</strong>. Licensed, insured, fast response anywhere in Mondeor and beyond — no call-out fee, no surprises.</p>
...
<section id="services" class="section">
  <div class="container">
    ...
    <h2 class="display" style="font-size:clamp(2.2rem,5vw,3.8rem);color:var(--navy);margin-top:8px">Every Plumbing Problem,<br>Solved Fast.</h2>
    <div class="svc-grid">
      ...
      <div class="svc-card">
        ...
        <div class="svc-icon"><svg viewBox="0 0 24 24"><path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z"/></svg></div>
...
<section id="process" class="section" style="background:var(--off)">
  <div class="container">
    <div class="eyebrow">How We Work</div>
    <h2 class="display" style="font-size:clamp(2rem,4.5vw,3.2rem);color:var(--navy);margin-top:8px">What Happens When You Call.</h2>
    <div class="svc-grid">
      <div class="svc-card">
        <div class="svc-num">01</div>
        <h3>Fast Response</h3>
        <p>Call, WhatsApp, or fill in our form. We dispatch a plumber to your location as quickly as possible — emergencies prioritised.</p>
      </div>
      <div class="svc-card">
        <div class="svc-num">02</div>
        <h3>Proper Assessment</h3>
        <p>We diagnose the actual problem on-site — not just the symptoms — before recommending any fix.</p>
      </div>
      <div class="svc-card">
      ...
      <div class="svc-card">
        ...
        <p>The job gets done properly the first time, using SABS-approved materials and PIRB-compliant methods.</p>
      </div>
      <div class="svc-card">
        <div class="svc-num">05</div>
        <h3>Clean Finish & Follow-Up</h3>
        <p>We clean up after every job and make sure you're satisfied. Compliance certificates issued where applicable.</p>
      </div>
    </div>
  </div>
</section>
  ...
  <div class="container">
    <div class="why-2col">
      <div>
        ...
        <h2 class="display" style="font-size:clamp(2rem,4vw,3.4rem);color:var(--navy);margin:8px 0 32px">We Do the Job Right.<br>Every Single Time.</h2>
        <div>
          ...
          <div class="why-row"><div class="why-n">03</div><div class="why-c"><h3>30-Minute Local Response</h3><p>Based in Mondeor, we reach all of Johannesburg South fast for emergencies.</p></div></div>
  ...
  <div class="container">
    <div style="display:flex;justify-content:space-between;align-items:flex-end;margin-bottom:44px;flex-wrap:wrap;gap:16px">
      <div>
        ...
        <h2 class="display" style="font-size:clamp(2rem,4vw,3.4rem);color:var(--navy);margin-top:8px">Don't Take Our Word For It.</h2>
      </div>
      <a href="<?php echo esc_url($review); ?>" target="_blank" class="btn btn--red">⭐ Leave a Review</a>
    </div>
    <div class="rev-grid">
      <div class="rev-card"><div class="rev-stars">★★★★★</div><p class="rev-text">"The best experience I've had with a plumber. The plumber was very professional, arrived on time, and sorted out my plumbing issue quickly. Price was fair, would definitely use again and highly recommend."</p><div class="rev-author">Sharral Raman</div><div class="rev-loc">Local Guide</div><div class="rev-tag">✓ Google Review</div></div>
      <div class="rev-card"><div class="rev-stars">★★★★★</div><p class="rev-text">"Great service! The plumber was professional, fixed my leaking kitchen tap quickly and efficiently, and the price was decent. Highly recommend."</p><div class="rev-author">Sherry Sprinkles</div><div class="rev-loc">Google Review</div><div class="rev-tag">✓ Google Review</div></div>
      <div class="rev-card"><div class="rev-stars">★★★★★</div><p class="rev-text">"Thank you Charles and team for an amazing job done. You guys are highly professional and efficient. Highly recommended."</p><div class="rev-author">Terry-Anne Mohamed</div><div class="rev-loc">Google Review</div><div class="rev-tag">✓ Google Review</div></div>
    </div>
  </div>
</section>
...
<section id="areas" class="section section--dark">
  <div class="container">
    ...
    <h2 class="display" style="font-size:clamp(2rem,4vw,3.4rem);color:#fff;margin-top:8px">Serving Mondeor<br>&amp; Johannesburg South.</h2>
...
<section id="articles" class="section" style="background:var(--off)">
  <div class="container">
    ...
    <p style="max-width:600px;margin:14px 0 36px">Practical plumbing advice for Mondeor and Johannesburg South — written by our own team.</p>
...
<section id="faq" class="section">
  <div class="container" style="max-width:800px">
    ...
    <div class="faq-list">
      ...
      <div class="faq-item"><div class="faq-q" onclick="toggleFaq(this)">How fast can you respond to an emergency?<div class="faq-icon"><svg viewBox="0 0 24 24"><path d="M7 10l5 5 5-5z"/></svg></div></div><div class="faq-a">We aim to be on-site within 30 minutes for emergencies in and around Mondeor, and as fast as possible across our wider Johannesburg South coverage area. Being local is our biggest advantage.</div></div>
      ...
      <div class="faq-item"><div class="faq-q" onclick="toggleFaq(this)">Is there a plumber near me in Mondeor right now?<div class="faq-icon"><svg viewBox="0 0 24 24"><path d="M7 10l5 5 5-5z"/></svg></div></div><div class="faq-a">Yes — we're based at 10 Boswell Ave, Mondeor, so if you search "plumber near me" from Mondeor or a bordering suburb like Kibler Park, Meredale, Ormonde, Bassonia or Glenvista, we're typically the closest PIRB-registered team and can be on-site within 30 minutes.</div></div>
      <div class="faq-item"><div class="faq-q" onclick="toggleFaq(this)">How much does a plumber near me cost in Mondeor?<div class="faq-icon"><svg viewBox="0 0 24 24"><path d="M7 10l5 5 5-5z"/></svg></div></div><div class="faq-a">It depends on the job — a tap repair costs far less than a geyser replacement. We always give a free, no-obligation quote before starting, and we never charge a call-out fee, so you know the price before we begin.</div></div>
      <div class="faq-item"><div class="faq-q" onclick="toggleFaq(this)">Which suburbs near Mondeor do you cover?<div class="faq-icon"><svg viewBox="0 0 24 24"><path d="M7 10l5 5 5-5z"/></svg></div></div><div class="faq-a">Beyond Mondeor itself, we regularly work in Kibler Park, Meredale, Ormonde, Ridgeway, Winchester Hills, Bassonia, Glenvista and Rosettenville, plus the wider Johannesburg South area — see the full list of suburbs we serve below.</div></div>
      <div class="faq-item"><div class="faq-q" onclick="toggleFaq(this)">Can I book a same-day plumber in Mondeor?<div class="faq-icon"><svg viewBox="0 0 24 24"><path d="M7 10l5 5 5-5z"/></svg></div></div><div class="faq-a">In most cases, yes. Call or WhatsApp us and we'll confirm same-day availability for your suburb — emergencies (burst pipes, no hot water, blocked drains) are always prioritised.</div></div>
    </div>
  </div>
</section>

<?php
// FAQPage schema for the questions above — genuine Q&A content already
// visible on the page, marked up so Google can surface it as a rich result.
$faq_schema = ['@context'=>'https://schema.org','@type'=>'FAQPage','mainEntity'=>[
    ['@type'=>'Question','name'=>'Is there a call-out fee?','acceptedAnswer'=>['@type'=>'Answer','text'=>'No. We never charge a call-out fee. You only pay for the work carried out, and we always provide a clear quote before starting.']],
    ['@type'=>'Question','name'=>'How fast can you respond to an emergency?','acceptedAnswer'=>['@type'=>'Answer','text'=>'We aim to be on-site within 30 minutes for emergencies in and around Mondeor, and as fast as possible across our wider Johannesburg South coverage area.']],
    ['@type'=>'Question','name'=>'Do you work on weekends and public holidays?','acceptedAnswer'=>['@type'=>'Answer','text'=>'Yes — 24 hours a day, 7 days a week, including all South African public holidays.']],
    ['@type'=>'Question','name'=>'Are your plumbers PIRB registered?','acceptedAnswer'=>['@type'=>'Answer','text'=>'Yes. All our plumbers are registered with the Plumbing Industry Registration Board (PIRB). We issue compliance certificates for geyser installations and all qualifying work.']],
    ['@type'=>'Question','name'=>'Do you guarantee your work?','acceptedAnswer'=>['@type'=>'Answer','text'=>'Absolutely. Every repair and installation carries a workmanship guarantee. If the same problem recurs due to our work, we return and fix it at no charge.']],
    ['@type'=>'Question','name'=>'Can you help with insurance plumbing claims?','acceptedAnswer'=>['@type'=>'Answer','text'=>'Yes. We provide detailed invoices and technical reports for home insurance claims related to burst pipes, water damage, and other plumbing incidents.']],
    ['@type'=>'Question','name'=>'Is there a plumber near me in Mondeor right now?','acceptedAnswer'=>['@type'=>'Answer','text'=>'Yes — we\'re based at 10 Boswell Ave, Mondeor, so if you search "plumber near me" from Mondeor or a bordering suburb, we\'re typically the closest PIRB-registered team and can be on-site within 30 minutes.']],
    ['@type'=>'Question','name'=>'How much does a plumber near me cost in Mondeor?','acceptedAnswer'=>['@type'=>'Answer','text'=>'It depends on the job. We always give a free, no-obligation quote before starting, and we never charge a call-out fee.']],
    ['@type'=>'Question','name'=>'Which suburbs near Mondeor do you cover?','acceptedAnswer'=>['@type'=>'Answer','text'=>'Beyond Mondeor itself: Kibler Park, Meredale, Ormonde, Ridgeway, Winchester Hills, Bassonia, Glenvista, Rosettenville, and the wider Johannesburg South area.']],
    ['@type'=>'Question','name'=>'Can I book a same-day plumber in Mondeor?','acceptedAnswer'=>['@type'=>'Answer','text'=>'In most cases, yes. Call or WhatsApp us and we\'ll confirm same-day availability for your suburb — emergencies are always prioritised.']],
]];
    ...
    <div class="contact-2col">
      <div>
        ...
        <div>
          ...
          <div class="cm"><div class="cm-i"><svg width="19" height="19" fill="#F87171" viewBox="0 0 24 24"><path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z"/></svg></div><div><div class="cm-l">Location</div><div class="cm-v" style="color:#CBD5E1">10 Boswell Ave, Mondeor, Johannesburg South, 2095</div></div></div>
      ...
      <div>
        <?php if($maps): ?>
        <div class="map-wrap">
          <iframe src="<?php echo esc_url($maps); ?>" allowfullscreen loading="lazy" title="Mondeor Plumbing Services service area"></iframe>
        </div>
        <?php else: ?>
        <div class="map-wrap">
