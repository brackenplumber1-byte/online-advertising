 ...
 * Mondeor Plumbing Services — articles listing page.
...
<div class="page-hero">
  ...
  <div class="container">
    ...
    <h1 class="display">Plumbing Tips for Mondeor<br>&amp; Johannesburg South Homeowners</h1>
    <p>Practical advice on geysers, leaks, drains and everything plumbing — written by the team at Mondeor Plumbing Services.</p>
    ...
    <div class="articles-grid" style="margin-bottom:12px">
      <a href="<?php echo esc_url(home_url('/geyser-repair-vs-replacement/')); ?>" style="display:block;background:#fff;border-radius:8px;overflow:hidden;box-shadow:0 2px 16px rgba(0,0,0,.07);text-decoration:none">
        ...
        <div style="padding:22px">
          <h2 style="font-size:1.15rem;color:var(--navy);margin-bottom:10px;line-height:1.3">Geyser Repair vs Replacement Guide</h2>
      ...
      <a href="<?php echo esc_url(home_url('/plumbing-emergency-gauteng/')); ?>" style="display:block;background:#fff;border-radius:8px;overflow:hidden;box-shadow:0 2px 16px rgba(0,0,0,.07);text-decoration:none">
        ...
        <div style="padding:22px">
          <h2 style="font-size:1.15rem;color:var(--navy);margin-bottom:10px;line-height:1.3">Plumbing Emergency: What to Do</h2>
          <p style="font-size:.88rem;color:var(--muted);margin:0">Burst pipe, flooding or no water? Follow these steps first, then call us.</p>
        </div>
      </a>
    </div>
  </div>
